...
class Mismatch_Identifier_PluginDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        ...
        # ✅ Initialize output/error capturers with proper argument
    ...
    def safe_append_to_grid_browser(self, message):
        if self.grid_generation_browser:
            try:
                self.grid_generation_browser.append(str(message))
            except RuntimeError:
                pass
